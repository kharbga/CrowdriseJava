...
public class JFrameProblem extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jDateChooserSearch.setBounds(320, 90, 87, 20);
    ...
    private void jMenuItemDemandeActionPerformed(java.awt.event.ActionEvent evt) {
        this.setVisible(true);
    }

    private void jTxtFldDeposerActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO add your handling code here:
    }

    private void jTxtFldListeDemandesActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO add your handling code here:
    }

    private void jTxtFldListeDemandes1ActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO add your handling code here:
    }

    private void jMenuItemContactActionPerformed(java.awt.event.ActionEvent evt) {
        try {
    ...
    private void jBtnModifierActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void jBtnJoindreFileActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void jBtnAccepterActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void jBtnRefuserActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void jBtnSupprimSolAccepteActionPerformed(java.awt.event.ActionEvent evt) {
        int action = JOptionPane.showConfirmDialog(JFrameProblem.this, "Voulez vous vraiment terminer la suppression ! ", "Confirmation Suppression", JOptionPane.OK_CANCEL_OPTION);
    ...
    private void jBtnSupprimSolRejeteActionPerformed(java.awt.event.ActionEvent evt) {
        int action = JOptionPane.showConfirmDialog(JFrameProblem.this, "Voulez vous vraiment terminer la suppression ! ", "Confirmation Suppression", JOptionPane.OK_CANCEL_OPTION);
    ...
    private void jTableProbSolMouseClicked(java.awt.event.MouseEvent evt) {

        jTableSolution.setModel(new SoluModel((int) jTableProbSol.getValueAt(jTableProbSol.getSelectedRow(), 0)));
        jScrollPane4.setViewportView(jTableSolution);
    }

    private void jCmboCategSearchActionPerformed(java.awt.event.ActionEvent evt) {

    }

    private void jTxtFldSearchTitreActionPerformed(java.awt.event.ActionEvent evt) {

    }

    private void jBtnDeposerActionPerformed(java.awt.event.ActionEvent evt) {
        if (jTxtFldTitreProb.getText() == null || jTxtFldTitreProb.getText().equals("")) {
        ...
        } else if (jDateChooser1.getDate() == null || jDateChooser1.getDate().equals("")) {
            JOptionPane.showMessageDialog(this, "Le champ Deadline est obligatoire", "", JOptionPane.WARNING_MESSAGE);
        } else if (jDateChooser1.getDate() != null && jDateChooser1.getDate().before(new java.util.Date())) {
            ...
            try {
                Probleme p = new Probleme(WIDTH, jTxtFldTitreProb.getText(), jTxtAreaDescription.getText(),
                        jDateChooser1.getDate(), String.valueOf(num + 1), jComboCategorie.getSelectedItem().toString());
    ...
    private void jTxtFldSearchTitreMouseClicked(java.awt.event.MouseEvent evt) {

        jTxtFldSearchTitre.setText("");
        jTxtFldSearchTitre.setForeground(Color.BLACK);
    }

    private void jTxtFldSearchTitreMouseExited(java.awt.event.MouseEvent evt) {

    }

    private void jBtnDownLoadProblemActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    /**
     * telecharger solution changer type de fichier_solution -> BD en int
     * changer requete find allsol comme find all prob pour recuperer id du
     * fichier et chercher ds la table media le path pour telecharger et
     * afficher le nom ds le tab
     */
    private void jBtnDownLoadSolutionActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                frameProbleme.setResizable(false);
                //frameProbleme.setLocation((Toolkit.getDefaultToolkit().getScreenSize().width - getSize().width) / 2, (Toolkit.getDefaultToolkit().getScreenSize().height - getSize().height) / 2);
